namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side definition for the "ERCFenceCross" form type. </para>
    ...
    /// </remarks>
    public partial class ERCFenceCrossFormType : FormType
    {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "ERCFenceCross";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Fence with Cross");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Fence with Cross");
