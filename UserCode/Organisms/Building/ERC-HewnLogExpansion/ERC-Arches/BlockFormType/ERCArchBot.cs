namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side definition for the "ERCArchBot" form type. </para>
    ...
    /// </remarks>
    public partial class ERCArchBotFormType : FormType
    {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "ERCArchBot";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Arch Bottom");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Arch Bottom");
