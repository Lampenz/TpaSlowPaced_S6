namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side definition for the "ERCRampTwoB" form type. </para>
    ...
    /// </remarks>
	[NextRamp(typeof(ERCRampTwoAFormType), 0)]
    public partial class ERCRampTwoBFormType : FormType
    {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "ERCRampTwoB";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Short Ramp B");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Short Ramp B");
