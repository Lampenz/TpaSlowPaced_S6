...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    /// </summary>
    public partial class FortyFiveFormGroup : FormGroup
    {
        /// <summary>Defines the name of the form group.</summary>
        public override string Name => "45 Degree"; //noloc
        /// <summary>The pural localization name for block form group.</summary> 
        public override LocString DisplayName => Localizer.DoStr("45 Degree");
        /// <summary>The tooltip description for the food item.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("45 Degree");
