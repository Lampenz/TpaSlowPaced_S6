namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side definition for the "ERCArchMid" form type. </para>
    ...
    /// </remarks>
    public partial class ERCArchMidFormType : FormType
    {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "ERCArchMid";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Arch Middle");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Arch Middle");
