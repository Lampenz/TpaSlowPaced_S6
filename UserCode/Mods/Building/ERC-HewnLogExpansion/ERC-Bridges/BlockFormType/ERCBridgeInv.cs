namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side definition for the "ERCBridgeInv" form type. </para>
    ...
    /// </remarks>
    public partial class ERCBridgeInvFormType : FormType
    {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "ERCBridgeInv";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Inverted Bridge Deck");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Inverted Bridge Deck");
        /// <summary>The block FormGroup this form type belongs to</summary>
        public override Type GroupType => typeof(BridgesFormGroup);
