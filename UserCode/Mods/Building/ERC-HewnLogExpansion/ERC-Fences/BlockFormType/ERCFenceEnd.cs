namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side definition for the "ERCFenceEnd" form type. </para>
    ...
    /// </remarks>
    public partial class ERCFenceEndFormType : FormType
    {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "ERCFenceEnd";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Fence End");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Fence End");
