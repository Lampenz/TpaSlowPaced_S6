    ...
    public partial class PaletteRecipe : RecipeFamily
    {
        public PaletteRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Wood", 20, typeof(CarpentrySkill)),      // Added Wood (20250729-Lampenz)
                    new IngredientElement("WoodBoard", 15, typeof(CarpentrySkill)), 
                    new IngredientElement("HewnLog", 15, typeof(CarpentrySkill)),   
    ...
    public partial class StockageOutilsRecipe : RecipeFamily
    {
        public StockageOutilsRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("HewnLog", 8, typeof(CarpentrySkill)), // Recette personnalisable : "5" Hewnlog.
    ...
    public partial class Petite_Simple_EtagereRecipe : RecipeFamily
    {
        public Petite_Simple_EtagereRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(NailItem), 10, typeof(MechanicsSkill)), // Recette personnalisable : "5" Clous.
    ...
    public partial class Petite_Double_EtagereRecipe : RecipeFamily
    {
        public Petite_Double_EtagereRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(NailItem), 20, typeof(MechanicsSkill)), // Recette personnalisable : "10" Clous.
        ...
        public GrandStockageWoodRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(SturdyWoodenPlankItem)),      // Recette personnalisable : "20" Wood.
