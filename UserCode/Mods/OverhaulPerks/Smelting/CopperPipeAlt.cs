...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CopperPipeAlt".</para>
    ...
    public partial class CopperPipeAltRecipe : RecipeFamily
    {
        public CopperPipeAltRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CopperPipeAlt",  //noloc
                displayName: Localizer.DoStr("Machined Copper Pipe"),
                ...
                {
                    new CraftingElement<CopperPipeItem>(3)
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CopperPipeAltRecipe), start: 0.8f, skillType: typeof(SmeltingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Copper Pipe"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Machined Copper Pipe"), recipeType: typeof(CopperPipeAltRecipe));
