...
namespace Eco.Mods.TechTree
{
	...
	[Serialized]
    public partial class IndustryWorktablesTalent : Talent
    {
        public IndustryWorktablesTalent()
        {
    ...
    [Serialized]
    [LocDisplayName("Industrial Machinery")]
    [LocDescription("Reduced cost for workstations. Makes all crafting a little slower.")]
    public partial class IndustryWorktablesTalentGroup : TalentGroup
    {
        public IndustryWorktablesTalentGroup()
        {
            Talents = new Type[]
            {
                typeof(IndustryWorktablesTalent),
            };
