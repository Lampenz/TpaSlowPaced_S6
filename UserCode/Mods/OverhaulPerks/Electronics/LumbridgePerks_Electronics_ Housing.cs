...
namespace Eco.Mods.TechTree
{
	...
	[Serialized]
    public partial class ElectronicsHousingTalent : Talent
    {
        public ElectronicsHousingTalent()
        {
    ...
    [Serialized]
    [LocDisplayName("Bright Ideas")]
    [LocDescription("Reduced cost for furniture. Makes all crafting a little slower.")]
    public partial class ElectronicsHousingTalentGroup : TalentGroup
    {
        public ElectronicsHousingTalentGroup()
        {
            Talents = new Type[]
            {
                typeof(ElectronicsHousingTalent),
            };
