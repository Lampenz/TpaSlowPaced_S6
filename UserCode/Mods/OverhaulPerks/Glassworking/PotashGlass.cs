...
namespace Eco.Mods.TechTree
{
    ...
    public partial class PotashGlassRecipe : RecipeFamily
    {
        public PotashGlassRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PotashGlass",  //noloc
                displayName: Localizer.DoStr("Potash Glass"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(SandItem), 4,typeof(GlassworkingSkill)),
                    new IngredientElement(typeof(CharcoalItem), 8, typeof(GlassworkingSkill) ),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PotashGlassRecipe), start: 1.2f, skillType: typeof(GlassworkingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Glass"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Potash Glass"), recipeType: typeof(PotashGlassRecipe));
