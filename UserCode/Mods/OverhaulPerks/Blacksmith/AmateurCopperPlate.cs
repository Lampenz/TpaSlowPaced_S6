...
namespace Eco.Mods.TechTree
{
    ...
    [RequiresSkill(typeof(BlacksmithSkill), 0)]
    [Ecopedia("Items", "Products", subPageName: "Copper Plate Item")]
    public partial class AmateurCopperPlateRecipe : RecipeFamily
    {
        public AmateurCopperPlateRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CopperPlate",  //noloc
                displayName: Localizer.DoStr("Artisanal Copper Plate"),
                ...
                {
                    new CraftingElement<CopperPlateItem>(2)
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AmateurCopperPlateRecipe), start: 6, skillType: typeof(BlacksmithSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Copper Plate"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Artisanal Copper Plate"), recipeType: typeof(AmateurCopperPlateRecipe));
