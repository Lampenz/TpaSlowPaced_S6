...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SpecialistHardwoodHewnLog".</para>
    ...
    public partial class SpecialistHardwoodHewnLogRecipe : RecipeFamily
    {
        public SpecialistHardwoodHewnLogRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SpecialistHardwoodHewnLog",  //noloc
                displayName: Localizer.DoStr("Specialist Hardwood Hewn Log"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SpecialistHardwoodHewnLogRecipe), start: 0.16f, skillType: typeof(LoggingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Hewn Log"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Specialist Hardwood Hewn Log"), recipeType: typeof(SpecialistHardwoodHewnLogRecipe));
