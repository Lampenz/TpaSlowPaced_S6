...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SpecialistSoftwoodHewnLog".</para>
    ...
    public partial class SpecialistSoftwoodHewnLogRecipe : RecipeFamily
    {
        public SpecialistSoftwoodHewnLogRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SpecialistSoftwoodHewnLog",  //noloc
                displayName: Localizer.DoStr("Specialist Softwood Hewn Log"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SpecialistSoftwoodHewnLogRecipe), start: 0.16f, skillType: typeof(LoggingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Hewn Log"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Specialist Softwood Hewn Log"), recipeType: typeof(SpecialistSoftwoodHewnLogRecipe));
