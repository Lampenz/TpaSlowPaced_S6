...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Housing Objects", "Outdoor", subPageName: "Barrel Item")]
            public partial class MetroBarrel01Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(MetroBarrel01Item);
        public override LocString DisplayName => Localizer.DoStr("Barrel");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = MetroBarrel01Item.homeValue;
    ...
    [LocDescription("Barrel")]
    [Ecopedia("Housing Objects", "Outdoor", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(5000)] // Defines how heavy MetroBarrel01 is.
            public partial class MetroBarrel01Item : WorldObjectItem<MetroBarrel01Object>
    {
