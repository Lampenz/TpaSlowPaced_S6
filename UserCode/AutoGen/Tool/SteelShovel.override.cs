...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelShovelItem : ShovelItem
    {
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           // Static values
        private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(SteelShovelItem), typeof(ShovelToolEfficiencyTalent)), CreateCalorieValue(20, typeof(GatheringSkill), typeof(SteelShovelItem)));
        private static IDynamicValue damage                 = CreateDamageValue(1, typeof(GatheringSkill), typeof(SteelShovelItem));
