...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronShovelItem : ShovelItem
    {
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           // Static values
        private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(IronShovelItem), typeof(ShovelToolEfficiencyTalent)), CreateCalorieValue(20, typeof(GatheringSkill), typeof(IronShovelItem)));
        private static IDynamicValue damage                 = CreateDamageValue(1, typeof(GatheringSkill), typeof(IronShovelItem));
