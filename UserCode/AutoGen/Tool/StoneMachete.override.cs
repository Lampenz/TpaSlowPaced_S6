...
namespace Eco.Mods.TechTree
{
    ...
    public partial class StoneMacheteItem : MacheteItem
    {
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           // Static values
        private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(StoneMacheteItem), typeof(GatheringToolEfficiencyTalent)), CreateCalorieValue(20, typeof(HuntingSkill), typeof(StoneMacheteItem)));
        private static IDynamicValue damage                 = new MultiDynamicValue(MultiDynamicOps.Sum, new TalentModifiedValue(typeof(StoneMacheteItem), typeof(GatheringToolStrengthTalent), 0), CreateDamageValue(1, typeof(HuntingSkill), typeof(StoneMacheteItem)));
        private static IDynamicValue exp                    = new ConstantValue(0.1f);
        private static IDynamicValue tier                   = new ConstantValue(1);
        private static IDynamicValue perkDamage             = new MultiDynamicValue(MultiDynamicOps.Sum, new ConstantValue(0), new TalentModifiedValue(typeof(StoneMacheteItem), typeof(GatheringToolStrengthTalent), 0));
