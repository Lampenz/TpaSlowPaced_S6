...
namespace Eco.Mods.TechTree
{
    ...
    [Weight(10000)]
    [SalvageCost(typeof(WoodScrap), 4.0f, typeof(Textiles), 1.0f)]
    ...
    public partial class WoodShopCartRecipe : RecipeFamily
    {
        public WoodShopCartRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CottonFabricItem), 24,typeof(BasicEngineeringSkill)),
                    new IngredientElement("HewnLog", 30,typeof(BasicEngineeringSkill)), //noloc
                    new IngredientElement(typeof(WoodCartItem), 2, true),
                    new IngredientElement(typeof(StoreItem), 2, true),
    ...
    [RequireComponent(typeof(SharedMovableLinkComponent))]
