...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Coconut Milk" item. 
    ...
    [LocDisplayName("Coconut Milk")] // Defines the localized name of the item.
    [Weight(10)] // Defines how heavy the Milk is.
    [LocDescription("Coconut milk, made from the finest coconuts")] //The tooltip description for the food item.
    public partial class MilkItem : FoodItem
    {

        /// <summary>The plural localization name for the food item.</summary>
        public override LocString DisplayNamePlural     => Localizer.DoStr("Coconut Milk");
