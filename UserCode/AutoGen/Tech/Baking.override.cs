    ...
    public partial class BakingSkillBookRecipe : RecipeFamily
    {
        public BakingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CulinaryResearchPaperBasicItem), 10, typeof(MillingSkill)),
                    new IngredientElement(typeof(MetallurgyResearchPaperAdvancedItem), 5, typeof(MillingSkill)),
                    new IngredientElement(typeof(GeologyResearchPaperAdvancedItem), 2, typeof(MillingSkill)),
                    new IngredientElement(typeof(GatheringResearchPaperAdvancedItem), 2, typeof(MillingSkill)),
                    new IngredientElement("Basic Research", 15, typeof(MillingSkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BakingSkillBookRecipe), start: 15, skillType: typeof(MillingSkill));
