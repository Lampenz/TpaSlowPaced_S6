    ...
    public partial class CookingSkillBookRecipe : RecipeFamily
    {
        public CookingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CulinaryResearchPaperBasicItem), 10, typeof(ButcherySkill)),
                    new IngredientElement(typeof(MetallurgyResearchPaperAdvancedItem), 5, typeof(ButcherySkill)),
                    new IngredientElement(typeof(DendrologyResearchPaperAdvancedItem), 2, typeof(ButcherySkill)),
                    new IngredientElement(typeof(GatheringResearchPaperAdvancedItem), 2, typeof(ButcherySkill)),
                    new IngredientElement("Basic Research", 15, typeof(ButcherySkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CookingSkillBookRecipe), start: 15, skillType: typeof(ButcherySkill));
