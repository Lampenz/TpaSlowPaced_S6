...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AdvancedCookingUpgradeRecipe : RecipeFamily
    {
        public AdvancedCookingUpgradeRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(FishNChipsItem), 5, true),
                    new IngredientElement(typeof(WildMixItem), 5, true),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AdvancedCookingUpgradeRecipe), start: 15, skillType: typeof(AdvancedCookingSkill));
        ...
        EfficiencyModule
    {
        ...
        public AdvancedCookingUpgradeItem() : base(ModuleTypes.None, 1f) { }
