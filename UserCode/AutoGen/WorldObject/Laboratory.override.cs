...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LaboratoryObject : WorldObject, IRepresentsItem
    {
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<LiquidConverterComponent>().Setup(typeof(WaterItem), typeof(ChemicalWasteFluidItem), BlockOccupancyType.WaterInputPort, BlockOccupancyType.SewageOutputPort, 0.3f, 0.9f);
    ...
    [SalvageCost(typeof(BioResidue), 2.0f, typeof(IronScrap), 4.0f)]
    [AllowPluginModules(ItemTypes = new[] { typeof(OilDrillingUpgradeItem), typeof(BasicUpgradeItem), typeof(AdvancedUpgradeItem), typeof(ModernUpgradeItem) })] //noloc
    ...
    public partial class LaboratoryRecipe : RecipeFamily
    {
        public LaboratoryRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(IronBarItem), 20,typeof(MechanicsSkill)),
                    new IngredientElement(typeof(GlassItem), 15,typeof(MechanicsSkill)),
                    new IngredientElement(typeof(PaperItem), 20,typeof(MechanicsSkill)),
                    new IngredientElement("Lumber", 8,typeof(MechanicsSkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LaboratoryRecipe), start: 15, skillType: typeof(MechanicsSkill));
